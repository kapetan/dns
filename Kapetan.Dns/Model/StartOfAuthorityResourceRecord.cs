...
namespace Kapetan.Dns.Model
{
    public class StartOfAuthorityResourceRecord : ResourceRecordBase
    {
        ...
        {
            var data = new Marshalling.ByteStream(Options.SIZE + master.Size + responsible.Size);
            ...
            : base(record)
        {
            ...
            var tail = Marshalling.Struct.GetStruct<Options>(message, dataOffset, Options.SIZE);
